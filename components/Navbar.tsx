      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="hidden md:flex items-center">
            <Link
              href="/tarjetas"
              className="px-4 py-1.5 rounded-md text-sm font-semibold text-white bg-[#1DB954] hover:bg-[#17a349] transition-colors"
            >
              Comparar tarjetas
            </Link>
          </div>
      ...
      {open && (
        <div className="md:hidden border-t border-[#e5e7eb] bg-white px-4 py-2">
          ...
          <div className="pt-2 pb-1">
            <Link
              href="/tarjetas"
              className="block w-full text-center px-4 py-2 rounded-md text-sm font-semibold bg-[#1DB954] text-white"
              onClick={() => setOpen(false)}
            >
              Comparar tarjetas
            </Link>
