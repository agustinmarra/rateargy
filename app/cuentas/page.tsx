...
const FILTRO_MAP: Record<string, (p: typeof CUENTAS_MOCK[0]) => boolean> = {
  ...
  digital: (p) =>
    p.beneficios.some((b) => b.toLowerCase().includes('app') || b.toLowerCase().includes('digital') || b.toLowerCase().includes('online')),
  tradicional: (p) =>
    ['Banco Galicia', 'Banco Santander', 'Banco Nación'].includes(p.banco),
}
      ...
      <div className="bg-white border-b border-[#e5e7eb]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <p className="text-[#6b7280] text-base max-w-xl">
            Cuentas digitales y tradicionales comparadas. Encontrá la que mejor rinde tu plata.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-start gap-3 bg-[#f0fdf4] border border-[#86efac] rounded-xl p-4 mb-7">
          ...
          <p className="text-sm text-[#374151]">
            <span className="font-semibold text-[#1a1a1a]">Importante:</span> Las tasas de rendimiento
            varían diariamente. Los datos son de carácter informativo y pueden diferir de la tasa actual.
          </p>
        </div>
              ...
              <div className="flex items-start justify-between px-5 pt-5 pb-4 border-b border-[#f3f4f6]">
                <div>
                  <div className="flex items-center gap-2 flex-wrap mb-0.5">
                    <span className="font-semibold text-sm text-[#1a1a1a]">{cuenta.nombre}</span>
                    {cuenta.tag && (
              ...
              <div className="px-5 py-4">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-[#f3f4f6]">
                  <div>
                    ...
                    <div className="font-semibold text-sm text-[#1DB954]">Sin costo</div>
                  </div>
                  <a
        ...
        <div className="mt-10 pt-6 border-t border-[#e5e7eb]">
          <p className="text-xs text-[#9ca3af] text-center max-w-2xl mx-auto">
            Algunos links son de afiliados. Las tasas de rendimiento son referenciales y varían según el banco.
          </p>
        </div>
      </div>
    </div>
